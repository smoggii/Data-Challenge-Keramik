...
Dieses Projekt klassifiziert SVG-Konturen von Keramikfragmenten durch Vergleich mit einer Referenzbibliothek vollständiger Gefäße. Der Algorithmus verwendet Template-Matching mit automatischer Skalierung, Alignment und mehreren Score-Komponenten.
