...
1. **Feature Extraction**: Parses SVG paths to extract mathematical descriptors including wall thickness, symmetry, and Fourier components.
2. **Classification**: Matches test samples against a reference database using weighted similarity scores.
...
```text
├── svg_files/                        # Folder containing test SVG files
├── images_typentafel/                # Folder containing reference SVG drawings
├── keramik_svg_classifier_newfeatures.py  # Advanced vector-based classifier
├── keramik_svg_classifier.py         # Baseline vector classifier
